...
This is a subversive sutra, for it "cuts" through "traditional" or "conservative" interpretations of the Buddha's teachings, as represented by the Hīnayāna scriptures (the "inferior way"). It goes through a series of apparent contradictions discussed in dialogues between the Buddha and his disciple Subhūti. These dialogues emphasise the idea of inherent existence, and shows that all phenomena are empty of a permanent, independent self-nature (`śūnyatā`). They also emphasise the importance of non-attachment and the practice of compassion towards all beings (because these beings are ultimately lacking in inherent existence as well, our perceptions of them are manifestations of ourselves).
...
- Giving gifts without basing these on the five collections (skhandhas). Acts of "kindness" must be intrinsically "good" and not attached to any perception of self, other, or phenomena.
- Perceiving the Buddha through his physical characteristics (marks).
...
- The concepts of `srotāpanna` (stream-enterer), etc.
...
<Tabs syncKey="sanskrit">
<TabItem label="Translation">
> Furthermore, Subhūti, a `bodhisattva` should give a gift without being established or based in an object (`vastupratiṣṭhitena`). They should give a gift without being dependent or based on anything. They should give a gift without being based in form, nor in sounds, smells, tastes, tangibles, nor should they give a gift based on `dharmas` (mental-objects/phenomena). Thus, Subhūti, should a `bodhisattva` give a gift, in such a way that they are not based on even the perception of a sign (`nimittasaṃjñāyāṃ`).
>
...
> Just so, Subhūti, just so. For the `bodhisattva` who gives a non-dependent gift, it is not easy to grasp the measure of their store of merit. Furthermore, Subhūti, just so should a `bodhisattva` give a gift, as this foundation of meritorious action which consists of giving.
</TabItem>
...
> Much, Bhagavān, much, *sugata*. That son or daughter of good family would produce much merit on that account. Why is that? That itself, Bhagavān, is a non-collection (`askandhaḥ`). Therefore the `tathāgata` speaks of the 'store of merit' (`puṇyaskandhaḥ`) as 'non-store'.
