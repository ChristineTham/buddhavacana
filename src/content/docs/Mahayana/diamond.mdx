...
The `vajra` is a legendary and ritualistic tool or "weapon", symbolizing the properties of a diamond (indestructibility) and a thunderbolt (irresistible force). It is a round, symmetrical metal scepter with two ribbed spherical heads. The ribs may meet in a ball-shaped top, or they may be separate and end in sharp points. It is often paired with a bell (called `ghanta`). [Vajra and Bell](https://evamratna.com/blogs/evamratna-blogs/secrets-of-vajra-and-bell?)

Therefore it is no surprise that the `Vajracchedikā Prajñāpāramitā` ("Vajra Cutter Perfection of Wisdom Sūtra") is considered one the most celebrated and historically significant works in Mahāyāna Buddhism. It supposedly cuts through our perceptual view of the experienced world to reveal the "ultimate reality" which is of course awakening.

In many ways this is a counter-cultural and subversive sutra, for it "cuts" our conceptions of everything, including who the Buddha is and challenges conventional interpretations of the Buddha's teachings.
...
<Tabs syncKey="sanskrit">
<TabItem label="Translation">
> Furthermore, Subhūti, a `bodhisattva` should give a gift without being established in a thing (`vastupratiṣṭhitena`). They should give a gift without being established anywhere. They should give a gift without being established in form, nor in sounds, smells, tastes, tangibles, nor should they give a gift established in `dharmas` (mental-objects/phenomena). Thus, Subhūti, should a `bodhisattva` give a gift, in such a way that they are not established even in the perception of a sign (`nimittasaṃjñāyāṃ`).
>
> Why is that? The `bodhisattva`, Subhūti, who gives a gift unestablished — it is not easy, Subhūti, to grasp the measure of their store of merit (`puṇyaskandhasya`).
>
...
> Just so, Subhūti, just so. For the `bodhisattva` who gives a gift unestablished, it is not easy to grasp the measure of their store of merit. Furthermore, Subhūti, just so should a `bodhisattva` give a gift, as this foundation of meritorious action which consists of giving.
</TabItem>
...
<Tabs syncKey="sanskrit">
<TabItem label="Translation">
> What do you think, Subhūti? Is the `tathāgata` to be seen by the perfection of his marks (`lakṣaṇasaṃpadā`)?
...
> 
> Moreover, Subhūti, those `bodhisattvas` will not have served only one Buddha. They will not have planted roots of goodness (`kuśalamūlā`) under only one Buddha. Furthermore, Subhūti, they will have served many Buddhas, they will have planted roots of goodness under many Buddhas. They are the ones who, when these sutra-passages are being taught, will obtain even a single moment of clear faith (`ekacittaprasādamātram`).
> 
...
> 
> Why is that? Because, Subhūti, a `dharma` is not to be grasped, nor a non-`dharma`. Therefore, with this in mind, it was taught by the `tathāgata`: 'By those who know the raft-simile teaching (`dharmaparyāyaṃ`), `dharmas` themselves must be abandoned, how much more so non-`dharmas`.'
</TabItem>
...
<Tabs syncKey="sanskrit">
<TabItem label="Translation">
> What do you think, Subhūti? If some son or daughter of good family were to fill this three-thousand-great-thousand world-system (`tṛsāhasramahāsāhasrāṃ lokadhātuṃ`) with the seven precious jewels and give it as a gift—what do you think, Subhūti? Would that son or daughter of good family produce much merit (`puṇyaṃ`) on that account?

Subhūti said:

> Much, Bhagavān, much, *sugata*. That son or daughter of good family would produce much merit on that account. Why is that? That itself, Bhagavān, is a non-heap (`askandhaḥ`). Therefore the `tathāgata` speaks of 'store of merit' (`puṇyaskandhaḥ`) as 'non-store'.

The Bhagavān said:

> And yet, Subhūti, if a son or daughter of good family were to fill this three-thousand-great-thousand world-system with the seven precious jewels and give it as a gift, and if another were to take from this `dharmaparyāya` (discourse on the teaching) even just a four-line verse (`gāthām`), teach it to others, and illuminate it—this latter one would produce far more merit on that account, immeasurable, incalculable.
>
...
> And yet, Subhūti, if someone were to fill that many world-systems with the seven precious jewels and give them as a gift, and if another were to take from this `dharmaparyāya` even just a four-line verse (`gāthām`) and teach it to others — this one would produce far more merit on that account, immeasurable, incalculable.
</TabItem>
...
<Tabs syncKey="sanskrit">
<TabItem label="Translation">
> Furthermore, Subhūti, whatever spot of earth where from this `dharmaparyāya` even just a four-line verse is spoken or taught, that spot of earth would become like a `caitya` (shrine), worthy of worship by the world with its gods, humans, and asuras. How much more so, Subhūti, those who will uphold this `dharmaparyāya`! They will be endowed with the highest wonder. And in that spot of earth, the Teacher dwells, or someone else who is in the position of a guru.
</TabItem>
...
> What is the name of this `dharmaparyāya`, Bhagavān? And how should I remember it?
...
> And yet, Subhūti, if a woman or man were to renounce self-existences (`ātmabhāvān`) equal to the grains of sand in the Ganges river, and if another were to take from this `dharmaparyāya` even a four-line verse (`gāthām`) and teach it to others—this one would produce far more merit on that account, immeasurable, incalculable.
</TabItem>
...
> Much, Bhagavān, is that dust. It is spoken of by the `Tathāgata` as no-dust, therefore it is called 'dust particle'. And that which is the `lokadhātu` (world-system), that is a no-system spoken of by the `Tathāgata`, therefore it is called '`lokadhātu` (world-system)'.
...
> No, Bhagavān. For what reason? Those thirty-two `mahāpuruṣalakṣaṇas` (marks of a great man) that were spoken of by the `Tathāgata` are no-marks, therefore they are called 'the thirty-two `mahāpuruṣalakṣaṇas` (marks of a great man)'.

Bhagavān said:

> And furthermore, Subhūti, if a woman or a man were to renounce self-bodies equal to the sands of the river Ganges, and if someone, having learned from this `dharmaparyāya` (discourse on the Dharma) at least a four-lined verse, should teach it to others, this one on that account would generate much `puṇya` (merit), immeasurable, innumerable.

Then, indeed, the āyuṣmān Subhūti, from the force of the `dharma` (teaching), shed tears. Wiping away his tears, he said this to the Bhagavān: Wonderful, Bhagavān, most wonderful, Sugata, is this `dharmaparyāya` (discourse on the Dharma) spoken by the `Tathāgata`! From it, Bhagavān, knowledge has arisen in me. Never before has this `dharmaparyāya` (discourse on the Dharma) been heard by me. Endowed with the highest wonder will they be, Bhagavān, who, when this `sūtra` is being spoken, produce a `bhūtasaṃjñā` (perception of reality). And this, Bhagavān, which is a `bhūtasaṃjñā` (perception of reality), that itself is a [x-ṃ-j-x-ā x] therefore the `Tathāgata` speaks:

> bhū [xxx] `bhūtasaṃjñā` (perception of reality). It is no wonder to me, Bhagavān, that I understand and am convinced of this `dharmaparyāya` (discourse on the Dharma) as it is being spoken. Those beings, Bhagavān, who will take up this `dharmaparyāya` (discourse on the Dharma), who will master it, they will be endowed with the highest wonder. But furthermore, Bhagavān, no `ātmasaṃjñā` (perception of a self) will operate in them, no `satvasaṃjñā` (perception of a being), no `jīvasaṃjñā` (perception of a life-principle), no `pudgalasaṃjñā` (perception of a person). For what reason? The `Buddhas` (awakened ones), the Bhagavāns, are devoid of all perceptions.

Bhagavān said:

>  So it is, Subhūti. Endowed with the highest wonder will they be who, upon hearing this `dharmaparyāya` (discourse on the Dharma), will not be terrified, will not be frightened, will not fall into a state of terror. For what reason? This, Subhūti, is the `paramapāramitā` (supreme perfection) spoken of by the `Tathāgata`. And that `paramapāramitā` (supreme perfection) which the `Tathāgata` speaks of, immeasurable `Buddhas` (awakened ones), Bhagavāns, speak of it. Therefore it is called '`paramapāramitā` (supreme perfection)'.
>
> But furthermore, Subhūti, that which is the `Tathāgata`'s `kṣāntipāramitā` (perfection of patience), that itself is a no-perfection. For what reason? When, Subhūti, the king of Kali cut the flesh from my limbs, at that time I had no `ātmasaṃjñā` (perception of a self) or `satvasaṃjñā` (perception of a being) or `jīvasaṃjñā` (perception of a life-principle) or `pudgalasaṃjñā` (perception of a person). Had I at that time a perception of ill-will... I recall, Subhūti, in a past time, five hundred births ago, I was the sage who was the Preacher of Patience. Even there I had no `ātmasaṃjñā` (perception of a self), no `satvasaṃjñā` (perception of a being), no `jīvasaṃjñā` (perception of a life-principle), no `pudgalasaṃjñā` (perception of a person). Therefore, then, Subhūti, a `bodhisattva` (enlightenment-being), a `mahāsattva` (great being), having abandoned all perceptions ...
</TabItem>
...
<Tabs syncKey="sanskrit">
<TabItem label="Translation">
> ... [ḥrimāṇena] All those beings will bear my `aṃsa` (share) of `bodhi` (awakening). For what reason? It is not possible, Subhūti, for this `dharmaparyāya` (discourse on the Dharma) to be heard by beings of `hīnādhimuktika` (inferior resolve), nor is it possible for it to be heard, taken up, or mastered by those with an `ātmadṛṣṭika` (view of a self), or a `satva-jīva-pudgala-dṛṣṭika` (view of a being, life-principle, or person). This state of affairs does not exist. But furthermore, Subhūti, whatever spot of earth this `sūtra` shall be proclaimed upon, that spot of earth will be worthy of worship. It will be worthy of veneration and circumambulation by the world with its gods, humans, and asuras. That spot of earth will become like a `caitya` (shrine). Those `kulaputras` (sons of good family) or `kuladuhitṛs` (daughters of good family), Subhūti, who will take up `sūtra` passages of this kind, and master them, they will be despised, utterly despised. And whatever evil `karmas` (actions) of those beings from previous births were `apāyasaṃvartanīyāni` (leading to a lower rebirth), those will be extinguished in this very life through that despisal, and they will attain `buddhabodhi` (the awakening of a Buddha). I recall, Subhūti, in a time past, `asaṃkhyeya` (incalculable) `kalpas` (aeons) ago, more incalculable still, before Dīpaṃkara the `Tathāgata`, `Arhat`, `Samyaksaṃbuddha`, there were eighty-four koṭi-niyuta-śata-sahasras of `Buddhas`, whom I honored, and having honored, did not dishonor. And that I, Subhūti, honored those `Buddhas`, Bhagavāns, and did not dishonor them, and that in the last time, when the final `pañcāśat` (period of five hundred years) is occurring, they will take up these `sūtra` passages, and master them—of this latter `puṇyaskandha` (mass of merit), Subhūti, that former `puṇyaskandha` (mass of merit) does not approach even the one-hundredth part, nor the one-thousandth part, nor the one-hundred-thousandth part. It does not bear number, nor fraction, nor counting, nor comparison, nor analogy. Should I, Subhūti, declare the `puṇyaskandha` (mass of merit) of those `kulaputras` (sons of good family) and `kuladuhitṛs` (daughters of good family), to what extent those beings, `kulaputras` and `kuladuhitṛs`, will at that time acquire a `puṇyaskandha` (mass of merit), beings would attain madness or go into mental distraction. But furthermore, Subhūti, this `dharmaparyāya` (discourse on the Dharma) is inconceivable; its result is likewise inconceivable.

He said:

> How, Bhagavān, should one who has set out in the `bodhisatvayāna` (vehicle of the Bodhisattvas) stand, how should one practice, how should one control the mind? | Bhagavān said | Here, Subhūti, one who has set out in the `bodhisatvayāna` (vehicle of the Bodhisattvas) should produce the thought thus: "All beings are to be led by me to final `nirvāṇa` (extinguishment) in the `anupadhiśeṣa nirvāṇadhātu` (realm of extinguishment without remaining residue)." And having thus led beings to final `nirvāṇa` (extinguishment), not a single being has been led to final `nirvāṇa` (extinguishment).
</TabItem>
...
<Tabs syncKey="sanskrit">
<TabItem label="Translation">
> For what reason? If, Subhūti, a `satvasaṃjñā` (perception of a being), `jīvasaṃjñā` (perception of a life-principle), or `pudgalasaṃjñā` (perception of a person) should operate in a `bodhisattva` (enlightenment-being), he should not be called a '`bodhisattva` (enlightenment-being)'. For what reason? There is not, Subhūti, any `dharma` (phenomenon) which is named 'one who has set out in the `bodhisatvayāna` (vehicle of the Bodhisattvas)'. What do you think, Subhūti, is there any `dharma` (phenomenon) by which the `Tathāgata` fully awakened to `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening) in the presence of Dīpaṃkara `Tathāgata`?

He said:

> There is no `dharma` (phenomenon), Bhagavān, by which the `Tathāgata` fully awakened to `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening) in the presence of Dīpaṃkara `Tathāgata`.

He said:

> Therefore I was prophesied by Dīpaṃkara `Tathāgata`: "You, young man, in a future time, will be a `Tathāgata`, `Arhat`, `Samyaksaṃbuddha`, named Śākyamuni." For what reason? '`Tathāgata`', Subhūti, is an epithet for `tathatā` (suchness). Whoever, Subhūti, should say thus: "The `Tathāgata` has fully awakened to `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening)"— there is no `dharma` (phenomenon), Subhūti, that has been fully awakened to as `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening) by the `Tathāgata`. The `dharma` (phenomenon), Subhūti, that was fully awakened to by the `Tathāgata`, therein is neither truth nor falsehood. Therefore the `Tathāgata` says: "All `dharmas` (phenomena) are `buddhadharmas` (phenomena of a Buddha)." 'All `dharmas` (phenomena)', Subhūti, all of them are no-`dharmas`; therefore they are called 'all `dharmas` (phenomena)'.
>
> Just as, for example, Subhūti, there might be a man with a large body, a great body. Subhūti said | That which was spoken of by the `Tathāgata` as a man with a large body, a great body—a no-body, Bhagavān, was spoken of by the `Tathāgata`. Therefore he is called 'a man with a large body, a great body'. Bhagavān said | So it is, Subhūti. A `bodhisattva` (enlightenment-being) who would say thus: "I shall lead beings to final `nirvāṇa` (extinguishment)" should not be called a '`bodhisattva` (enlightenment-being)'. For what reason? Is there, Subhūti, any `dharma` (phenomenon) that is called a '`bodhisattva` (enlightenment-being)'
...
> Therefore the `Tathāgata` says: "All `dharmas` (phenomena) are without being, without life-principle, without person." A `bodhisattva` (enlightenment-being), Subhūti, who would say thus: "I shall accomplish the `kṣetravyūhas` (arrays of a field)," he too should be spoken of in the same way. For what reason? '`Kṣetravyūhas` (arrays of a field)', '`kṣetravyūhas` (arrays of a field)', Subhūti, are no-arrays spoken of by the `Tathāgata`; therefore they are called '`kṣetravyūhas` (arrays of a field)'. That `bodhisattva` (enlightenment-being), Subhūti, who is convinced "``dharmas`` (phenomena) are selfless, `dharmas` (phenomena) are selfless," is declared by the `Tathāgata`, the `Arhat`, the `Samyaksaṃbuddha` as '`bodhisattva` (enlightenment-being), `bodhisattva` (enlightenment-being)'. What do you think, Subhūti, does the `Tathāgata` possess the `māṃsacakṣuḥ` (fleshly eye)?

He said:

> So it is, Bhagavān, the `Tathāgata` possesses the `māṃsacakṣuḥ` (fleshly eye).
</TabItem>
...
> What do you think, Subhūti, does the `Tathāgata` possess the `divyaṃ cakṣuḥ` (divine eye), the `prajñācakṣuḥ` (wisdom eye), the `dharmacakṣuḥ` (Dharma eye), the `buddhacakṣuḥ` (Buddha eye)? He said, so it is, Bhagavān, the `Tathāgata` possesses the `divyaṃ cakṣuḥ` (divine eye), the `prajñācakṣuḥ` (wisdom eye), the `dharmacakṣuḥ` (Dharma eye), the `buddhacakṣuḥ` (Buddha eye).
...
Bhagavān said:
> As many beings as there are, Subhūti, in those `lokadhātus` (world-systems), I would know their various streams of thought. For what reason? '`Cittadhārā` (stream of thought)', '`cittadhārā` (stream of thought)', Subhūti, are no-streams spoken of by the `Tathāgata`; therefore they are called '`cittadhārā` (stream of thought)'. For what reason? Past thought, Subhūti, is not apprehended. Future thought is not apprehended. Present thought is not apprehended. What do you think, Subhūti, if a `kulaputra` (son of good family) or `kuladuhitṛ` (daughter of good family), having filled this three-thousand-great-thousand `lokadhātu` (world-system) with the seven precious things, were to give a gift, would he or she on that account generate much `puṇya` (merit)?
...
> So it is, Subhūti, so it is. That `kulaputra` (son of good family) or `kuladuhitṛ` (daughter of good family) would on that account generate much `puṇya` (merit). If, Subhūti, a `puṇyaskandha` (mass of merit) existed, the `Tathāgata` would not have said, '`puṇyaskandha` (mass of merit), `puṇyaskandha` (mass of merit)'. What do you think, Subhūti, is the `Tathāgata` to be seen by the perfection of the `rūpakāya` (form-body)?

He said:

> No, Bhagavān, the `Tathāgata` is not to be seen by the perfection of the `rūpakāya` (form-body). For what reason? 'Perfection of the `rūpakāya` (form-body)', 'perfection of the `rūpakāya` (form-body)', this is a no-perfection spoken of by the `Tathāgata`. Therefore it is called 'perfection of the `rūpakāya` (form-body)'.
...
> What do you think, Subhūti, does it occur to the `Tathāgata` thus: "A `dharma` (teaching) has not been taught by me"? Whoever, Subhūti, should say thus: "A `dharma` (teaching) has been taught by the `Tathāgata`," he would be slandering me, Subhūti, with what is grasped as untrue. For what reason? 'Discourse on the `Dharma`', 'discourse on the `Dharma`', Subhūti, there is no `dharma` (phenomenon) that is found which is named 'discourse on the `Dharma`'.

He said:

> Are there, Bhagavān, any beings who will exist in a future time, who, upon hearing `dharmas` (teachings) of this kind being spoken, will have faith?

Bhagavān said:

> They, Subhūti, are not beings, nor non-beings. For what reason? 'All beings', Subhūti, are no-beings spoken of by the `Tathāgata`. Therefore they are called 'all beings'.
</TabItem>
...
> There is no `dharma` (phenomenon), Bhagavān, that was fully awakened to by the `Tathāgata` as `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening).

Bhagavān said:

> So it is, Subhūti, so it is. Not even a minute `dharma` (phenomenon) exists or is found there. Therefore it is called '`anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening)'. But furthermore, Subhūti, that `dharma` (phenomenon) is equal; there is nothing unequal in it. Therefore it is called '`anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening)'. Through being without life-principle, without being, without person, that same `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening) is fully awakened to through all wholesome `dharmas` (phenomena). 'Wholesome `dharmas` (phenomena)', 'wholesome `dharmas` (phenomena)', Subhūti, they are indeed no-`dharmas` spoken of by the `Tathāgata`. Therefore they are called 'wholesome `dharmas` (phenomena)'. And furthermore, Subhūti, if someone, having collected heaps of the seven precious things as numerous as the Sumerus, kings of mountains, in the three-thousand-great-thousand `lokadhātu` (world-system), were to give a gift, and if someone, having learned from this `Prajñāpāramitā` at least a four-lined verse, should teach it to others—of this `puṇyaskandha` (mass of merit), Subhūti, that former `puṇyaskandha` (mass of merit) does not approach even the one-hundredth part, as far as not bearing even an analogy.
>
> What do you think, Subhūti, does it occur to the `Tathāgata` thus: "Beings have been liberated by me"? Not so, indeed, Subhūti, should it be seen. For what reason? There is no being who has been liberated by the `Tathāgata`. If again, Subhūti, there had been any being who was liberated by the `Tathāgata`, that itself would be for him a grasp of a self, a grasp of a being, a grasp of a life-principle, a grasp of a person. 'Grasp of a self', Subhūti, is a no-grasp spoken of by the `Tathāgata`. And it is grasped by `bālapṛthagjanas` (foolish common people). '`Bālapṛthagjanas` (foolish common people)', Subhūti, are no-people spoken of by the `Tathāgata`. Therefore they are called '`bālapṛthagjanas` (foolish common people)'. What do you think, Subhūti, is the `Tathāgata` to be seen by the `lakṣaṇasaṃpad` (perfection of marks)?

He said:

> so it is, Bhagavān, the `Tathāgata` is to be seen by the `lakṣaṇasaṃpad` (perfection of marks).

Bhagavān said:

> If, again, Subhūti, the `Tathāgata` were to be seen by the `lakṣaṇasaṃpad` (perfection of marks), a wheel-turning king would also be a `Tathāgata`.

He said:

> As I understand the meaning of the Bhagavān's words, the `Tathāgata` is not to be seen by the `lakṣaṇasaṃpad` (perfection of marks).
...
> it cannot be known.
>
> What do you think, Subhūti, was `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening) fully awakened to by the `Tathāgata` through the `lakṣaṇasaṃpad` (perfection of marks)? Not so, indeed, Subhūti, should it be seen. Not, Subhūti, was `anuttarā samyaksaṃbodhi` (unexcelled perfect and complete awakening) fully awakened to by the `Tathāgata` through the `lakṣaṇasaṃpad` (perfection of marks). That which, furthermore, Subhūti, might be thus: "For those who have set out in the `bodhisatvayāna` (vehicle of the Bodhisattvas), the destruction or annihilation of any `dharma` (phenomenon) is proclaimed"—not so, indeed, Subhūti, should it be seen. For those who have set out in the `bodhisatvayāna` (vehicle of the Bodhisattvas), the destruction or annihilation of any `dharma` (phenomenon) is not proclaimed. And furthermore, Subhūti, if a `kulaputra` (son of good family) or `kuladuhitṛ` (daughter of good family), having filled `lokadhātus` (world-systems) equal to the sands of the river Ganges with the seven precious things, were to give a gift to the `Tathāgatas`, `Arhats`, `Samyaksaṃbuddhas`, and if a `bodhisattva` (enlightenment-being) should attain `kṣānti` (forbearance) with regard to selfless `dharmas` (phenomena), this one would generate much more `puṇya` (merit) on that account. Not, indeed, Subhūti, should a `puṇyaskandha` (mass of merit) be grasped by a `bodhisattva` (enlightenment-being).

He said:

> The `puṇyaskandha` (mass of merit), Bhagavān, should be taken up.

Bhagavān said:

> It should be taken up, Subhūti, not grasped. Therefore it is said, 'it should be taken up'.
> 
> But furthermore, Subhūti, whoever should say thus: "The `Tathāgata` goes or comes, or stands, or sits, or lies down," he does not understand the meaning of my words. For what reason? '`Tathāgata`', Subhūti, has not come from anywhere, nor gone to anywhere. Therefore he is called '`Tathāgata`', `Arhat`, `Samyaksaṃbuddha`. And furthermore, Subhūti, if a `kulaputra` (son of good family) or `kuladuhitṛ` (daughter of good family) were to grind into ink as many `lokadhātus` (world-systems) as there are dust particles in the three-thousand-great-thousand `lokadhātu` (world-system)—just as, for instance, a collection of atoms—what do you think, Subhūti, would that collection of atoms be large? He said, so it is, Bhagavān, that collection of atoms would be large. For what reason? If, Bhagavān, it were a collection, the Bhagavān would not have said, 'a collection of atoms'. For what reason? That which is called 'a collection of atoms' has been spoken of by the Bhagavān as a no-collection. Therefore it is called 'a collection of atoms'. And that which the `Tathāgata` speaks of as the 'three-thousand-great-thousand `lokadhātu` (world-system)', that has been spoken of by the `Tathāgata` as a no-system. Therefore it is called the 'three-thousand-great-thousand `lokadhātu` (world-system)'. For what reason? If, Bhagavān, a system existed, that itself, Bhagavān, would be a `piṇḍagrāha` (grasp of a substance). And that very thing which has been spoken of by the `Tathāgata` as a `piṇḍagrāha` (grasp of a substance), has been spoken of by the `Tathāgata` as a no-grasp. Therefore it is called '`piṇḍagrāha` (grasp of a substance)'.
</TabItem>
...
> No, Bhagavān. For what reason? That which, Bhagavān, is the `ātmadṛṣṭi` (view of a self) spoken of by the `Tathāgata`, has been spoken of by the `Tathāgata` as a no-view. Therefore it is called '`ātmadṛṣṭi` (view of a self)'.

Bhagavān said:

> Thus, Subhūti, by one who has set out in the `bodhisatvayāna` (vehicle of the Bodhisattvas) are all `dharmas` (phenomena) to be known, to be convinced of. And they are to be convinced of in such a way that not even a `dharmasaṃjñā` (perception of a phenomenon) arises. For what reason? '`Dharmasaṃjñā` (perception of a phenomenon)', '`dharmasaṃjñā` (perception of a phenomenon)', Subhūti, this is a no-perception spoken of by the `Tathāgata`. Therefore it is called '`dharmasaṃjñā` (perception of a phenomenon)'. And furthermore, Subhūti, if a `bodhisattva` (enlightenment-being), a `mahāsattva` (great being), having filled immeasurable, innumerable `lokadhātus` (world-systems) with the seven precious things, were to give a gift, and if a `kulaputra` (son of good family) or `kuladuhitṛ` (daughter of good family), having taken from this `Prajñāpāramitā` at least a four-lined verse, were to uphold it, teach it, master it, this one would on that account generate much more `puṇya` (merit), immeasurable, innumerable. And how should one proclaim it? As a no-proclamation one should proclaim it. Therefore it is said 'one should proclaim it'.
>
