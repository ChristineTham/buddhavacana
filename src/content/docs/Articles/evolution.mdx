...
The 3-aṅgā categories are almost certainly pre-sectarian. The 9-aṅgā categories are possibly pre-sectarian but the 12-aṅgā additions are specific to Mahāyāna doctrine.
...
Sometime after the Buddha's death but before the division into sects - potentially during the First Council itself - a decision was made to organise the suttas not by `aṅgā` but by up to four Nikāyas/Āgamas. Only some of these collections have survived:
...
This may seem a strange way to divide the suttas, but the intention was probably to create four more or less equal sized collections for memorisation by different groups of monastics. It is possible there was initially just one collection (possibly the Samyutta - see below) which over time was split into other collections.
...
## Post sectarian divergence

:::caution
This is a work in progress. Need to expand on:

* Case Studies (DN2 etc.)
* DN33 and DN34
:::
