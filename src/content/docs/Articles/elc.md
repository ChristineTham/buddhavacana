---
title: The Eightfold Path as an application of Kolb's experiential learning cycle
sidebar:
  label: Experiential Learning Cycle
---

If we agree with Bronkhorst and Polak above, then the eightfold path can be regarded as a guide towards reflective thinking, and consciously revisiting past actions and mental constructs in order to perform "memory reconsolidation" with a view towards future optimal mental constructs and actions.
...
section Concrete Experience (CE)
CE : Right Awareness (sammāsati)
section Reflective Observation (RO)
RO : Right Focus (sammāsamādhi)
section Abstract Conceptualization (AC)
AC : Right View (sammādiṭṭhi)
   : Right Resolve (sammāsaṅkappa)
section Active Experimentation (AE)
AE : Right Speech (sammāvācā)
