---
title: The Devolution of Buddha's teachings
sidebar:
  label: "Devolution"
  order: 23
---
...
:::note
Jonathan A. Silk in **Establishing / Interpreting / Translating: Is It Just That Easy?** [^Silk2015] critiques the traditional scholarly goal of establishing a single, pure, original version of a text, arguing this approach is particularly unsuitable for Buddhist scriptures which likely never had a singular "Ur-text" due to their oral origins and modular construction. He contends that creating an "eclectic edition" from various sources is a form of "textual eugenics," an authoritarian act that devalues the actual historical manuscripts used by communities and creates an artificial text that never existed. Instead, Silk advocates for a democratic or libertarian perspective that treats every manuscript and recension not as a "corrupt" variant but as a legitimate historical document, valuable for what it reveals about a text's reception and transmission. This rejection of a single authoritative text implies that there can be no single correct interpretation or translation, challenging scholars to respect the diversity of the textual tradition rather than imposing their own hierarchical and ultimately artificial version.

[^Silk2015]: Silk, Jonathan A. "Establishing / Interpreting / Translating: Is It Just That Easy?", Journal of the International Association of Buddhist Studies Volume 36/37 2013/2014 (2015).
:::
