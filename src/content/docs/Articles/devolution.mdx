...
The last two of the above were dismissed by the Buddha as being non-conducive nor leading to enlightenment, and he identified them as specifically the teachings of Āḷāra Kālāma and Rāma in [9M/3.6 Pāsarāsisutta](https://tipitaka2500.github.io/tipitaka/9M/3/3.6.html) and [9M/4.6 Mahāsaccakasutta](https://tipitaka2500.github.io/tipitaka/9M/4/4.6.html). See my translation of the latter in [Greater Discourse to Saccaka (`Mahāsaccakasutta`)](/budddhavacana/sutta/saccaka).

Yet, inexplicably, these methods were subsequently inserted into various suttas (for example [11M/3.1 Cūḷasuññatasutta](https://tipitaka2500.github.io/tipitaka/11M/3/3.1.html)), presumably by later disciples. However, these methods are not presented as end goals, but as stepping stones towards `suññataṁ` (emptiness) and in some respects Cūḷasuññatasutta seems to be a proto-`prajñāpāramitā` sutta that links Theravadan concepts of meditation to Mahāyāna doctrine.
