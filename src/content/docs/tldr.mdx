...
<big>The Buddha searched for the root cause of suffering. Why do living beings suffer, why is there sickness, aging and death?[^1] This is the ultimate quest: when we find the answer, then we will be free of suffering. He observed that we experience the world through our senses, and therefore each of us live in a perceived universe constructed or imagined by us. Our conceptions of who we are and the world we live in are ultimately nothing other than these aggregated perceptions of phenomena, and this is the source of our suffering. Once we let go (by deconstructing our perceptions of the universe that we have built in our minds), we will be liberated.[^2]</big>

---

[^1]: See [The Four Realisations](/buddhavacana/sutta/realisations)
[^2]: See [Dependent Origination](/buddhavacana/sutta/deporig)

## Is this just mumbo jumbo and gobbledegook?

No, it is not. The Buddha was not a magician, he was not a "spiritualist", he was not a holy man or religious teacher, he is not a divine omniscient being incapable of farting. Or at least he did not have the intention to be regarded as such, however many gradually saw him as all that, and more.[^3]

[^3]: See [Was the Buddha omniscient and was he able to predict the future?](/buddhavacana/buddha/omniscient)

He was not advocating eternal peace and happiness, an everlasting life, a spiritual attainment.[^4] He was not "enlightened" (in a spiritual or supramundane sense) nor did he achieve "perfect understanding" - these are just epithets bestowed upon him by his followers, who by and large have misunderstood his teachings.

[^4]: See [Nibbāna](/buddhavacana/articles/enlightenment)

He did not search for a metaphysical end to suffering, he was looking for the actual end to suffering. And he found it. And so can we, each one of us. There is nothing "divine" or "holy" or "celestial" about ending suffering - yes, in this very lifetime, not in some future birth in a heavenly realm.[^4]
...
We "create" our own suffering. And because of that, we can end our suffering.[^1]
...
After all, we are physically just a collection of atoms.[^8] When we die, those atoms (most of them anyway) will still persist, but possibly rearranged in new configurations.

[^8]: According to quantum mechanics, we are not even that, for those atoms are probability and wave functions that don't even exist until measured.
...
The Buddha came to the (logical) conclusion that our sense of "self" is generated from our subjective experiences (phenomena) and our accumulated thoughts. In other words, our "consciousness" is "constructed" and ephemeral. After all, our "consciousness" disappears when we fall asleep or become unconscious, and even when we dream we are often not ourselves but someone else. Furthermore, we are unaware or ignorant of the "constructed" or transient nature of our consciousness, and hence ignorance is the ultimate cause of suffering.
...
The Buddha's viewpoint can be described as "phenomenalism" -  everything we experience is through our senses and our imagination. We then construct a "world model" in our minds - a recreation of our spatial understanding of what we have perceived - and it is this world model that we experience, and not extrinsic reality.

Because of that. we are unable to determine whether the real world or physical universe actually exists. Our "world model" is effectively a mental construct - a "simulation" if you like - created by ourselves. It is formed from previous experiences, apperceptions, influenced and shaped by language (we "name" things that we can perceive). Therefore our "self" also is named and constructed.

The Buddha points out that this "self" and all the mental constructs are impermanent. They have no existence outside of our minds, and disappear when we die. Therefore the "world model" that we perceive is also impermanent, because it is nothing more than a mental construction.
...
The Buddha proposed a method based on an experiential learning cycle[^5], in eight steps.[^6] These steps are based on actively modifying our thoughts and actions, which in turn modifies our feelings and perceptions, which in turn modifies our consciousness and sense of self, and so on. It is like writing self modifying "code" that rewire our minds. We then perform an introspection process to monitor our progress, followed by an reflection thinking process that will lead us to actively experiment and adjust how our perception of the world has changed and whether we have reduced or eliminated suffering. It is a continuous feedback loop of learning and self-improvement.

[^5]: See [The Eightfold Path as an application of Kolb's experiential learning cycle](/buddhavacana/articles/elc)
[^6]: See [The Middle Way and the Eightfold Path](/buddhavacana/sutta/middle)
...
7. **Right Awareness**: Observe our thoughts and actions in the present moment. Introspectively observe and monitor our feelings and perceptions and determine how past and present behaviour and actions are influencing the present outcome.
...
[^7]: See [Did the Buddha Advocate morality and ethics?](/buddhavacana/articles/ethics)
...
Potentially one can imagine the above method would work with a sense of unease or dissatisfaction. One could also argue that grief or loss is an emotion that can be dealt with, and even physical pain can be ignored. Can we truly avoid or eliminate sickness, old age and death?
...
For more information, see [Did the Buddha teach meditation?](/buddhavacana/articles/meditation)

## Didn't the Buddha teach karma and rebirth?

Actually, he probably didn't. The concepts of karma and rebirth were pre-existing concepts in his time, belonging to religious beliefs such as Jainism and Vedicism. The Buddha may have adapted these concepts to fit his teachings, but he did not invent the concepts. For more information, see [Kamma and Rebirth](/buddhavacana/articles/kamma)
...
## How do the Buddha's teachings relate to modern methods and theories?

<CardGrid>
<LinkCard title="Kolb's Experiential Learning Cycle" description="The eightfold path can be regarded as a guide towards reflective thinking, and consciously revisiting past actions and mental constructs in order to perform 'memory reconsolidation' with a view towards future optimal mental constructs and actions." href="/buddhavacana/articles/elc" />
<LinkCard title="Cognitive Behavioural Therapy (CBT)" description="The Buddha's phenomenological framework and the subsequent path to liberation is consistent with the principles of CBT." href="/buddhavacana/articles/cbt" />
<LinkCard title="Theory of Planned Behaviour (TPB)" description="The Buddha's phenomenological framework and subsequent liberation is consistent with modern theories of perception and behavioural science." href="/buddhavacana/articles/tpb" />
<LinkCard title="Ethical Frameworks" description="The Buddha's teachings are not dependent or reliant on specific ethical frameworks or views on morality." href="/buddhavacana/articles/ethics" />
</CardGrid>
