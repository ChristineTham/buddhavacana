...
<CardGrid stagger={true}>
  ...
  <Card title="Was The Buddha A Divine Being?" icon="starlight">
    ...
    <LinkCard title="From Man to Archetype" description="The Evolution of perceptions of the Buddha" href="/buddhavacana/buddha/evolution" />
  </Card>
  <Card title="What Is So Special About His Teachings?" icon="seti:smarty">
    ...
    <LinkCard title="Meditation" description="Did the Buddha teach meditation?" href="/buddhavacana/articles/meditation" />
  </Card>
  <Card title="Was The Buddha A Philosopher Or Spiritual Leader?" icon="seti:react">
    His preserved core teachings are not merely philosophy, or spiritual guidance, but are practical and experiential. Unlike religions, his teachings are not based on faith or belief, but on direct experience and personal verification.
  ...
  <Card title="Why Should We Bother To Understand His Teachings?" icon="heart">
    ...
    <LinkCard title="Core Teachings" description="The Buddha's early and pre-sectarian teachings, attributed to him by his followers" href="/buddhavacana/sutta/intro" />
    <LinkCard title="Beyond the Core - Mahāyāna" description="A radical expansion and reconstruction of the Buddha's teachings - the current dominant form of Buddhism." href="/buddhavacana/articles/mahayana" />
  </Card>
</CardGrid>
...
<CardGrid>
  <Card title="Tidipa" icon="translate">
    ![Tidipa](../../assets/images/tidipa.png)
    <LinkCard title="tidipa.github.io" description="My open source, independent, rational English translation of selections from the Pāḷi Tipiṭaka" href="https://tidipa.github.io" target="_blank" />
  </Card>
  <Card title="Kaccayana" icon="document">
    ![Tidipa](../../assets/images/kaccayana.jpg)
    <LinkCard title="kaccayana.github.io" description="A translation of the earliest available Pāli grammar into modern English" href="https://kaccayana.github.io" target="_blank" />
  </Card>
  <Card title="World Tipitaka Edition" icon="open-book">
    ![Tipitaka2500](../../assets/images/tipitaka.jpg)
    <LinkCard title="tipitaka2500.github.io" description="The Buddhist Era 2500 Great International Council Pāḷi Tipiṭaka, Roman Script 2005” (Mahāsaṅgīti Tipiṭaka Buddhavasse 2500), hosted by me" href="https://tipitaka2500.github.io" target="_blank" />
  </Card>
  <Card title="Khandhaja" icon="pencil">
    ![Tipitaka2500](../../assets/images/khandhaja.jpeg)
    <LinkCard title="khandhaja.github.io" description="Second Brain framework based on `pañcupādānakkhandhā`, the five collections that supposedly all living beings are composed of, according to the Buddha" href="https://khandhaja.github.io" target="_blank" />
  </Card>
  <Card title="Rosely" icon="add-document">
    ![Tipitaka2500](../../assets/svg/logo.svg)
    <LinkCard title="rosely.hellotham.com" description="A Colour Palette and Design System
    based on millennial pinks and purples" href="https://rosely.hellotham.com" target="_blank" />
  </Card>
  <Card title="Personal Web Site" icon="seti:info">
    ![Chris Tham](../../assets/images/christham.jpeg)
    <LinkCard title="christham.net" description="artist, consultant, cyclist, designer, musician, photographer, world traveller" href="https://christham.net" target="_blank" />
  </Card>
</CardGrid>
