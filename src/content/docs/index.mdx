...
*mini statue of The Buddha in front of Mt Sumeru*, photo taken at a private garden at Robertson, NSW, Australia on 12 October 2024 on a Sony α7R and Zeiss FE 55mm lens.
...
<CardGrid stagger={true}>
  ...
  <Card title="What Did He Do?" icon="seti:xml">
    ...
    <LinkCard title="What Did The Buddha Teach?" description="His core teachings, based on the early discourses" href="/buddhavacana/buddha/teach" />
...
<LinkCard title="Want to read everything?" description="Start here. Use the sidebar menu on the left (on a desktop) or the menu button on the top right (mobile/tablet) to select a page." href="/buddhavacana/about" />
