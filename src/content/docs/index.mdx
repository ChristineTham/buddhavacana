...
description: The Word of the Buddha
...
<LinkCard title="Too Long; Didn't Read" description="If you can't be bothered to explore this website, this is the gist of what the Buddha taught" href="/buddhavacana/tldr" />
...
*mini statue of The Buddha in front of Mt Sumeru*, photo taken at a private garden at Robertson, NSW, Australia on 12 October 2014 on a Sony α7R and Zeiss FE 55mm lens.
...
<CardGrid stagger={true}>
  ...
  <Card title="What Did He Do?" icon="seti:xml">
    ...
    <LinkCard title="What Did The Buddha Teach?" description="A summary, based on the early discourses" href="/buddhavacana/buddha/teach" />
  ...
  <Card title="Why Should We Bother To Understand His Teachings?" icon="heart">
    ...
    <LinkCard title="Core Teachings" description="The Buddha's Teachings, in his own words" href="/buddhavacana/sutta/intro" />
  </Card>
</CardGrid>

<LinkCard title="Want to read everything?" description="Start by clicking here. Then use the sidebar menu on the left (on a desktop) or the menu button on the top right (mobile/tablet) to select a page." href="/buddhavacana/about" />
