...
I also dislike some terms used by other translators, such as "cankers", "taints", "defilements"  for `āsavā` (I use "non optimal flows") - I feel it is important not to use emotive or ethicised words to refer to thoughts and mental conditions, however some flows will lead to extinguishment, others lead away from extinguishment. I also dislike the words "conditioned" and "unconditioned" and prefer to refer to `saṅkhato` as "constructed" and `asaṅkhato` as "unconstructed" since the literal meaning of `saṅkhato` is "put together."
