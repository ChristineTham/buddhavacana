---
categories: ["Sutta"]
tags: ["ariyo aṭṭhaṅgiko maggo"]
title: Eightfold Path (`ariyo aṭṭhaṅgiko maggo`)
sidebar:
  label: "Eightfold Path"
  order: 103
description: >
  The Eightfold Path is a step by step iterative feedback-based approach to realising the cessation of suffering.
---
...
2. `sammāsaṅkappa` (right intention): `saṅkappa` means "intention; purpose" and it is clear those who wish to undertake the path should have the commitment and the determination to do so.
