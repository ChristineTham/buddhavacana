...
The two "extremes" referred to by the Buddha could also be a reference to the "extremes" of Brahmanical thinking (the eternal self exists and can be purified through rituals) vs Jain thinking (the illusion of the physical self needs to be shattered through asceticism).
