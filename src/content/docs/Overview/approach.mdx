...
* I also believe that the original teachings are completely integrated and self-consistent, so the key to rediscovering Buddha's teachings is to find an internally coherent and interlocking subset (see [The Core Teachings of the Buddha](/buddhavacana/sutta/intro)).
...
* Where possible, evaluate the teaching based on the Pāli (or Sanskrit) text and not an English translation. In particular, retain the Pāli/Sanskrit words for any technical terms.
