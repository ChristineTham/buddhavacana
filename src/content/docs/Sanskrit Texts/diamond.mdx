...
The Gilgit manuscript is poorly edited and the text rambles on with some repeated concepts. I suspect the text includes sections that are later additions to the sutra.
...
## From the Schøyen Collection MS2385
