...
Therefore, one should know that `prajñāpāramitā` is the great `mantra` (incantation), the great `mantra` of knowledge, the unsurpassed `mantra`, the unequalled `mantra`, the allayer of all `duḥkha` (suffering); it is truth because it is not false.
